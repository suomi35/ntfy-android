...
class AddFragment : DialogFragment() {
    ...
    private fun validateInputSubscribeView() {
        ...
        val instantToggleAllowed = if (subscribeUseAnotherServerCheckbox.isChecked
            && subscribeBaseUrlText.text.toString() == appBaseUrl) {
            true
        ...
        if (instantToggleAllowed) {
            ...
            subscribeForegroundDescription.visibility = View.VISIBLE
        }
