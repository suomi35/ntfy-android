...
class MainActivity : AppCompatActivity(), ActionMode.Callback, AddFragment.SubscribeListener, NotificationFragment.NotificationSettingsListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.main_root).applyStatusBarTopPadding()
        ...
        fab.applySystemBarMargin(right = true, bottom = true)
        ...
        mainListContainer.setColorSchemeResources(R.color.teal)
        mainListContainer.applySystemBarPadding(left = false, top = false, right = false, bottom = true)
